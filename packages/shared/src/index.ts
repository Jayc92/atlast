...
export {
  ...
  snapshotAnchorSchema,
  snapshotAnchorsMetadataSchema,
...
export {
  ...
  type HealthContextOverlayMetadata,
  type HealthContextResult,
  type HealthPathStep,
  type HealthProjection,
  type LatentRiskDerivation,
  type OverlayGap,
  type ReportedDirectHealthProjection,
