...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------- |
| S1    | Domain schemas in `packages/shared`: Evidence (incl. `recordedSequence`, safe-integer-bounded 1…2^53 − 1), Entity/Relationship subjects, content-addressed GraphAssertion revisions (rule trace, validity, conflict/ambiguity state), identifiers, `schemaVersion` — plus schema-rejection tests | ADR-0014 accepted                     |
...
| Graph/evidence representation decisions recorded as ADRs and human-approved      | ADRs 0014–0018 moved from Proposed to Accepted by human review                                                                  |
