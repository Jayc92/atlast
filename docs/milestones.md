...
## M6 — Internal Pilot Validation (baseline accepted; M6-A complete; M6-B complete; M6 remains open)
...
**Exit criteria (accepted, not yet satisfied):** see [docs/m6-plan.md § 15](m6-plan.md#15-m6-exit-criteria) for the complete, current list. None is checked. M6-A and M6-B — the first two authorized slices — are now complete but satisfy no exit criterion on their own, since every one of the six requires an actual unaided-tester run; M6-C remains separately gated and unauthorized before any exit-criterion-relevant work may proceed.
