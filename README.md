...
The M0 foundation is complete — the backend API shell lives in [apps/api](apps/api) and the web application shell in [apps/web](apps/web) — and **M1 is active and slice-gated** ([TASKS.md](TASKS.md)). Slices S1, S2, and S3 are complete and merged (PRs #7, #10, and #13). **Slice S4 (temporal foundations) was human-authorized 2026-07-31**, effective once the documentation PR recording that release merges to `main`; after that merge, contributions may include the bounded S4 scope ([HANDOFF.md § 7](HANDOFF.md)) plus maintenance and corrections of the existing foundation and merged slices. S5–S8 and M2+ remain gated on their own explicit releases ([docs/milestones.md](docs/milestones.md), [HANDOFF.md](HANDOFF.md)). All contributions — documentation or code — must comply with [GUARDRAILS.md](GUARDRAILS.md).
