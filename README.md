...
The M0 foundation is complete — the backend API shell lives in [apps/api](apps/api) and the web application shell in [apps/web](apps/web) — and **M1 is active and slice-gated** ([TASKS.md](TASKS.md)). Slices S1–S4 are complete and merged (PRs #7, #10, #13, and #16). **Slice S5 (reconciliation engine) is released — ADR-0022 was explicitly accepted 2026-08-05** — effective once the acceptance record merges to `main`; after that merge, contributions may include the bounded S5 scope ([HANDOFF.md § 7](HANDOFF.md), accepted [ADR-0022](docs/adr/0022-m1-reconciliation-policy-and-assertion-derivation.md)) plus maintenance and corrections of the existing foundation and merged slices. S6–S8 and M2+ remain gated on their own explicit releases ([docs/milestones.md](docs/milestones.md), [HANDOFF.md](HANDOFF.md)). All contributions — documentation or code — must comply with [GUARDRAILS.md](GUARDRAILS.md).
