...
- **Fact aging** — facts without fresh supporting evidence decay in confidence and are eventually marked stale (never silently deleted — topology history is data).
