...
The M0 foundation is complete — the backend API shell lives in [apps/api](apps/api) and the web application shell in [apps/web](apps/web) — and **M1 is active and slice-gated** ([TASKS.md](TASKS.md)). Slices S1 and S2 are complete and merged (PRs #7 and #10). **Slice S3 (synthetic fixture suite v1) was human-authorized 2026-07-30**, effective once the documentation PR recording that authorization merges to `main`; after that merge, contributions may include the bounded S3 scope ([HANDOFF.md § 7](HANDOFF.md)) plus maintenance and corrections of the existing foundation and merged slices. S4–S8 and M2+ remain gated on their own explicit releases ([docs/milestones.md](docs/milestones.md), [HANDOFF.md](HANDOFF.md)). All contributions — documentation or code — must comply with [GUARDRAILS.md](GUARDRAILS.md).
