...
> **Status: M0 and M1 complete; M2 explicitly authorized and phase-gated.** M2-A through M2-C are complete, with M2-C closed through PR #43 at `751d47c`. Joseph separately authorized M2-D only on 2026-08-13; its release becomes operational only after the authorization record merges and `main` is synchronized cleanly. **M2-E+ and M3+ remain unauthorized.** Read [PROJECT_SPEC.md](PROJECT_SPEC.md), [TASKS.md](TASKS.md), [docs/m2-plan.md](docs/m2-plan.md), and [HANDOFF.md](HANDOFF.md) before contributing.
...
The M0 foundation and M1 synthetic topology model are formally complete ([TASKS.md](TASKS.md)); M1 closed through PR #32 at `cff0545` on 2026-08-12. **M2-A through M2-C are complete, with M2-C closed through PR #43 at `751d47c`; Joseph then separately authorized M2-D only.** That release remains pending its authorization-record merge and clean synchronization checkpoint. See [docs/milestones.md](docs/milestones.md), [TASKS.md](TASKS.md), and [HANDOFF.md](HANDOFF.md). **M2-E+ and M3+ remain unauthorized.** All contributions must comply with [GUARDRAILS.md](GUARDRAILS.md).
