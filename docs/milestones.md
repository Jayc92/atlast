...
## M6 — Internal Pilot Validation (baseline accepted; M6-A complete; M6 remains open)
...
**Exit criteria (accepted, not yet satisfied):** see [docs/m6-plan.md § 15](m6-plan.md#15-m6-exit-criteria) for the complete, current list. None is checked. M6-A — the first authorized slice — is now complete but satisfies no exit criterion on its own; M6-B and M6-C remain separately gated and unauthorized before any exit-criterion-relevant work may proceed.
